...
# h0 = torch.zeros(num_layers,batch_size, hidden_size)   # 修改后的输入数据
#out 是RNN层的输出，它的形状通常是 [batch_size, sequence_length, hidden_size]
...
def getdata():
    ...
    tr1 =  np.concatenate((x1,y1,z1),axis=1) # 30 rows 3 columns
    # mm = MinMaxScaler()
